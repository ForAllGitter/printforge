...
export const DESIGNS: Design[] = [
  ...
  },
  {
    ...
    name: "Bitcoin coin",
    category: "Crypto",
    blurb: "Official Bitcoin ₿ on orange. White mark and 1 mm white rim. 28 × 14 mm.",
  ...
  },
  {
    ...
    name: "Litecoin coin",
    category: "Crypto",
    blurb: "Official Litecoin Ł on blue. White mark and 1 mm white rim. 28 × 14 mm.",
  ...
  },
  {
    ...
    name: "Dogecoin coin",
    category: "Crypto",
    blurb: "Dogecoin — cream Shiba on gold, white D. 28 × 14 mm.",
  ...
  },
  {
    ...
    name: "DigiByte coin",
    category: "Crypto",
    blurb: "Official DigiByte D — navy field, blue ring, white mark. 28 × 14 mm.",
